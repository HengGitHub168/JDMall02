	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.product_lv_item, null);
			holde = new ViewHolde();
			holde.iconIv = (SmartImageView) convertView
					.findViewById(R.id.product_iv);
			holde.nameTv = (TextView) convertView.findViewById(R.id.name_tv);
			holde.commentRateTv = (TextView) convertView
		...
		holde.commentRateTv.setText(bean.getCommentCount() + "条评价  好评"
				+ bean.getFavcomRate() + "%");
