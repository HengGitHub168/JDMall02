...
public class AlreadyOrderAdapter extends BaseAdapter {

	private List<ROrderListBean> mDatas = new ArrayList<ROrderListBean>();
	private Context mContext;
	private IOrderListClickListener mListClickListener;

	public void setListClickListener(IOrderListClickListener mListClickListener) {
		this.mListClickListener = mListClickListener;
	}

	public AlreadyOrderAdapter(Context c) {
		mContext = c;
	}
	...
	private void initChildProductIcon(ROrderListBean bean,
